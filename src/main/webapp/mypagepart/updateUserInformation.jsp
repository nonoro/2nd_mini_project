...
<div class="myPageMain">
    ...
    <div class="menuMain">
        ...
        <div class="menu-result-container" id="menu-result-container">
            ...
            <form action="#" style="text-align: left; border: 1px solid gray; padding: 10px" >
                <span class="updateElement">강아지이름 :</span><span class="updateText" style="margin-left: 12px"><input type="text"></span><br>
                <span class="updateElement">강아지생일 :</span><span class="updateText" style="margin-left: 12px"><input type="text"></span><br>
                <span class="updateElement">이메일 :</span><span class="updateText" style="margin-left: 39px"><input type="text"></span><br>
                <span class="updateElement">핸드폰번호 :</span><span class="updateText" style="margin-left: 13px"><input type="text"></span><br>
                <span class="updateElement">주소 :</span><span class="updateText" style="margin-left: 54px"><input type="text"></span><br>
                <span class="updateElement">현재비밀번호 :</span><span class="updateText" style="margin-left: 0px;"><input type="text"></span><br>
                <span class="updateElement">변경비밀번호 :</span><span class="updateText" style="margin-left: 0px;"><input type="text"></span><br>
                <span class="updateElement">프로필 :</span><span class="updateText" style="margin-left: 40px"><input class="btn btn-outline-secondary" type="file" style="width: 250px"></span><br>
