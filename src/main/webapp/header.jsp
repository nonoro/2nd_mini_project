...
<div class="header">
    ...
    <div class="header-center">
        <span style="display: inline-block; margin-top: 13px">👉&nbsp&nbsp공지안내드립니다&nbsp&nbsp👈</span>
    </div>
        ...
        <ul class="nav nav-pills">
            <c:choose>
                <c:when test="${empty loginUser}">
                    <li class="nav-item"><a href="${path}/mypagepart/signIn.jsp"
                                            class="nav-link">로그인</a></li>
                </c:when>
                <c:otherwise>
                    <li class="nav-item"><a href="${path}/front?key=login&methodName=logout"
                                            class="nav-link">로그아웃</a></li>
                </c:otherwise>
            </c:choose>
            <li class="nav-item"><a href="#" class="nav-link">장바구니</a></li>
<%--            <li class="nav-item"><a href="${path}/myPage.jsp" class="nav-link" id="myPage">마이페이지</a>--%>
...
<div class="banner">
    ...
    <div class="banner-center">
        <a href="${path}/index.jsp"><img
                src="${path}/img/logo.png" alt="" style="height: 190px; padding-top: 20px;"></a>
    </div>
...
<div class="topMenu">
    <div class="menuCenter">
        <ul class="menu01">
            ...
            <li><span>커뮤니티</span>
                 <ul class="dept01">
                    <li id="nop"><a href="${path}/front?key=board&methodName=categoryList&categoryCode=1">광고</a></li>
                    <li id="nop"><a href="${path}/front?key=board&methodName=categoryList&categoryCode=2">질병</a></li>
                    <li id="nop"><a href="${path}/front?key=board&methodName=categoryList&categoryCode=3">자유</a></li>
                </ul>
            </li>
        </ul>
    </div>
