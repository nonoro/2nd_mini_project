...
<div class="myPageMain">
    <div class="menuMain">
        <div class="menu-result-container" id="menu-result-container">
            <h2 style="margin-top: 20px; text-align: center ">광고게시판</h2>
...
<%--                        \${pageNo} = ${pageNo} , \${temp}=${temp} , \${startPage}=${startPage} , <br>--%>
                        ...
                        <c:if test="${(startPage-p.blockcount) > 0}"> <!-- (-2) > 0 -->
                            <a class="pagination-newer btn btn-secondary" style="margin-right: 10px" href="${path}/front?key=board&methodName=categoryList&pageNo=${startPage-1}&categoryCode=${categoryCode}">PREV</a>
                        </c:if>
