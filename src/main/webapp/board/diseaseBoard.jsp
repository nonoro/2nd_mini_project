...
<div class="myPageMain">
    <div class="menuMain">
        <div class="menu-result-container" id="menu-result-container">
            <h2 style="margin-top: 20px; text-align: center ">질병게시판</h2>
            <div class="menu-result-container-list" style="margin: 0 220px">
                ...
                <div style="text-align: right">
                    <a class="btn btn-outline-secondary"
                       href="${path}/board/write.jsp?&pageNo=${pageNo}&categoryCode=${categoryCode}">글쓰기</a><br>
                </div>
                <hr color="red">
                ...
                <nav class="pagination-container">
                    <div class="pagination" style="text-align: center; display: inline-block">
                        ...
                        <c:if test="${(startPage-p.blockcount) > 0}"> <!-- (-2) > 0 -->
                            <a class="pagination-newer btn btn-secondary"
				  ...
				  <c:forEach var='i' begin='${startPage}' end='${(startPage-1)+p.blockcount}'>
                      ...
                      <c:if test="${not doneLoop}">
                        ...
                        <c:if test="${(startPage+p.blockcount)<=p.pageCnt}">
                            <a class="pagination-older btn btn-secondary"
